    ...
    <DialogContent class="sm:max-w-[525px]">
      ...
      <div class="grid gap-4 py-4">
        <div class="grid grid-cols-4 items-center gap-4">
          <label for="exerciseTitle" class="text-right text-sm font-medium col-span-1">Title</label>
          <Input
            id="exerciseTitle"
            type="text"
        ...
        <div class="grid grid-cols-4 items-center gap-4">
          <label for="exerciseDescription" class="text-right text-sm font-medium col-span-1">Description</label>
          <Textarea
        ...
        <div class="grid grid-cols-4 items-center gap-4">
          ...
          <Select v-model="exerciseData.driveType" class="col-span-3">
        ...
        <div class="grid grid-cols-4 items-center gap-4">
          <label for="exerciseX" class="text-right text-sm font-medium col-span-1">X Position</label>
          <Input
            id="exerciseX"
            type="number"
        ...
        <div class="grid grid-cols-4 items-center gap-4">
          <label for="exerciseY" class="text-right text-sm font-medium col-span-1">Y Position</label>
          <Input
            id="exerciseY"
            type="number"
...
const handleAddExercise = () => {
  ...
  if (typeof exerciseData.x !== 'number' || typeof exerciseData.y !== 'number') {
